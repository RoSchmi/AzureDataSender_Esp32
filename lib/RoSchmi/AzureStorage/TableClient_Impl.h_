 ...
 ContType pContentType, AcceptType pAcceptType, ResponseType pResponseType, bool useSharedKeyLite)
{
  ...
  */
  ...
  const __FlashStringHelper * li4  = (F("xmlns=\"http://www.w3.org/2005/Atom\"> <id>http://"));
        char * li5  = (char *)_accountPtr->AccountName.c_str();
  const __FlashStringHelper * li6  = (F(".table.core.windows.net/"));
        char * li7  = (char *)validTableName;
  const __FlashStringHelper * li8  = (F("(PartitionKey='"));
        char * li9  = (char *)PartitionKey; 
  const __FlashStringHelper * li10  = (F("',RowKey='"));
        char * li11  = (char *)RowKey; 
  const __FlashStringHelper * li12  = (F("')</id><title /><updated>"));
        char * li13  = (char *)x_ms_timestamp;
  const __FlashStringHelper * li14  = (F("</updated><author><name /></author><content type=\"application/atom+xml\">"));
  const __FlashStringHelper * li15  = (F("<m:properties><d:PartitionKey>"));
        char * li16  = (char *)PartitionKey;
  const __FlashStringHelper * li17  = (F( "</d:PartitionKey><d:RowKey>"));
        char * li18  = (char *)RowKey;
  const __FlashStringHelper * li19  = (F("</d:RowKey>"));  
